...
class BlogController extends Controller
{
    public function index()
    {
        if (isset($_GET['search'])) {
            ...
            $blog = AuthorsBlog::where('title', 'LIKE', "%$searchVal%")->orderByDesc('created_at')->paginate(10);
            return view('admin.blog.index', compact('blog'));
        }
        $blog = AuthorsBlog::orderByDesc('created_at')->paginate(10);
        return view('admin.blog.index', compact('blog'));
    }
    ...
    public function get($id)
    {
        ...
        return view('admin.blog.single', compact('blogItem'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.blog.edit', compact('blogItem'));
    }

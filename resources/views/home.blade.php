                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2 col-6">
                                        <div class="tg-postbook">
                                            ...
                                            <div class="tg-postbookcontent">
                                                ...
                                                @endphp
                                                <span class="tg-bookwriter">By: <a href="{{ $authorLink }}">{{ $book->author->firstname.' '.$book->author->lastname }}</a></span>
                                                <span class="tg-bookprice">
        ...
        <div class="row">
            ...
            <div id="tg-authorscornerslider" class="tg-postslider tg-blogpost owl-carousel">
                ...
                <div class="item tg-author">
                    ...
                    @endphp
                    <figure><a href="{{ $link }}"><img src="{{ asset('storage/author/blog/image/thumbnail/'.$article->thumbnail) }}" alt="article image"></a></figure>
                    <div class="tg-post">
                        <ul class="tg-bookscategories">
...
<!--************************************
        Testimonials Start
*************************************-->
<section class="tg-bgtestimonials tg-haslayout" id="homeTestimonal" style="background: url({{ asset('img/uuuuuu.jpg') }}); background-size:cover; background-repeat:no-repeat;">
    {{--<div class="overlay" style=""></div>--}}
    <div class="tg-sectionspace tg-haslayout" {{--style="z-index:3;"--}}>
        <div class="container">
            <div class="row">

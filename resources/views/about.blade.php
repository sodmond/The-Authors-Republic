        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mb-3">
                    <div class="tg-calltoaction" style="padding:0 !important;">
                        <h2 style="color:#000;">Vision Statement</h2>
                        <h5>To create a vibrant and inclusive community that empowers authors, Poets and book writers to showcase their literary craftsmanship, 
                            collaborate, educate and inspire one another on their creative journey of shaping the society with words.</h5>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="tg-calltoaction" style="padding:0 !important;">
                        <h2 style="color:#000;">Mission Statement</h2>
                        <h5>The Authors' Republic aims to be the unique digital platform that fosters connections, networking, facilitates the exchange of ideas, 
                            and provides opportunities for authors, Poets and book writers to grow, learn, and achieve their literary aspirations.</h5>
                    </div>
                </div>
            </div>
        </div>

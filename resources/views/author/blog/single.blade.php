@extends('author.layouts.main', ['title' => ucwords($blogItem->title), 'activePage' => 'blogItems'])
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-6 text-right">
                                    <a class="btn btn-info" href="{{ route('author.blog.edit', ['id' => $blogItem->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    <button class="btn btn-danger" id="deleteBtn"><i class="fa fa-trash"></i> Delete</button>
                                    <input type="hidden" id="deleteUrl" value="{{ route('author.blog.trash', ['id' => $blogItem->id]) }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">

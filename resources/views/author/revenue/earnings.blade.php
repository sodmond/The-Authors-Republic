@extends('author.layouts.main', ['title' => 'Earnings', 'activePage' => 'revenue'])
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($earnings as $earning)
                                            <tr>
                                                <td>{{ $row++ }}</td>
                                                <td>
                                                    <a href="{{ route('author.order', ['id' => $earning->order_id]) }}">
                                                ...
                                                <td>
                                                    {{--<a class="btn btn-sm btn-custom" href="{{ route('author.earning', ['id' => $earning->id]) }}">
                                                        <i class="fa fa-eye"></i>
                                                    </a>--}}
                                                </td>
                                            </tr>
